...
public class InteractionPanelHandler {
    ...
    private void createButtons(){
        ...
        insertButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(!nameTextField.getText().isEmpty() && !salesTextField.getText().isEmpty()){
        ...
        searchSalesButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(!salesTextField.getText().isEmpty()) {
                    int sales = Integer.parseInt(salesTextField.getText());
    ...
    private void handleAnswer(String[] answer){
        if(answer != null && answer.length == 2){
            ...
            showText("Es wurde kein Eintrag zu Ihrer Suche gefunden.");
        }else{
            showText("Die Suche ergab ein unerwartetes Ergebnis. Fehler im MainController!");
        }
    }
}
